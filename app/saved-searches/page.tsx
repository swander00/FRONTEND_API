        ...
        <SectionCard className="mt-6">
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              {searches.length > 0 
                ? `Manage your ${searches.length} ${searches.length === 1 ? 'saved search' : 'saved searches'}` 
            ...
            <div className="space-y-4">
              {searches.map((search) => (
                <div
                  key={search.Id}
                  className={cn(
                    'group rounded-xl border border-gray-200 bg-white p-5 transition hover:border-blue-300 hover:shadow-md',
