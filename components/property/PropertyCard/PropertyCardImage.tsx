  ...
  return (
    <div className="relative w-full h-64 bg-gray-200 rounded-t-lg overflow-hidden group">
      ...
      <div className="absolute top-2 left-2 z-10 flex flex-col gap-1" onClick={(e) => e.stopPropagation()}>
        <MlsStatusBadge status={property.mlsStatus ?? property.status ?? 'Active'} variant="solid" />
      ...
      {property.images && property.images.length > 1 && (
        <div className="absolute bottom-2 left-1/2 transform -translate-x-1/2 z-10 flex gap-1" onClick={(e) => e.stopPropagation()}>
